...
HD_PWD='/home/jacob/Documents/CNCMillZybo/ZyboFPGA/ip_repo/edit_TestAdder_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestAdder_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestAdder_v1_0.tcl -notrace

...
HD_PWD='/home/jacob/Documents/CNCMillZybo/ZyboFPGA/ip_repo/edit_TestAdder_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestAdder_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestAdder_v1_0.tcl
